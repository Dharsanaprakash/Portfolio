  ...
  return (
    <section id="certifications" className="section-padding relative">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle, hsl(42 100% 60%), transparent)",
        }}
      />
        ...
        <div className="space-y-4">
          {certifications.map((cert, i) => (
            <motion.a
              ...
              whileHover={{ x: 8 }}
              className="group glow-card rounded-2xl p-6 md:p-8 flex items-start gap-5 cursor-pointer"
            >
              ...
              <ExternalLink
                size={18}
                className="text-muted-foreground/30 group-hover:text-highlight/60 transition-colors mt-1 flex-shrink-0 hidden md:block"
              />
            </motion.a>
          ))}
        </div>
